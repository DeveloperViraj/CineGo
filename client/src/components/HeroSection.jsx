    ...
    return (
        <div className='flex flex-col items-start justify-center gap-8 px-10 md:px-14 lg:px-23 bg-[url("/backgroundImage.jpg")] bg-cover bg-center h-screen max-md:overflow-hidden max-md:bg-[url("/mobileback.jpg")] max-md:bg-center max-md:bg-cover'>
            <div className="flex flex-col items-start justify-center max-md:text-sm mt-10 min-2xl:text-xl">
                ...
                <h1 className='text-6xl md: leading-18 max-w-120 font-semibold li mx-2 max-md:text-3xl max-md:leading-10'>AVENGERS: DOOMSDAY</h1>
                <div className="flex mx-3 my-2 gap-6 max-sm:flex-col max-sm:gap-2 text-gray-300 max-md:font-semibold">
                    ...
                    <div className="flex items-center">
                        <Calendar1Icon className='w-4 h-4 mx-1' />2026
                    </div>
                    <div className="flex items-center">
                        <ClockIcon className='w-4 h-4 mx-1' />2hr 45min
                    </div>
                </div>
                <p className='max-w-md mx-3 max-md:font-semibold min-2xl:max-w-lg text-gray-300 max-md:max-w-sm'>When a cosmic anomaly threatens to tear Earth apart, the Avengers reunite to face their most powerful enemy yet—Doomsday, a godlike being from a collapsed universe. As realities collide and time unravels, the fate of the multiverse lies in their hands.</p>
